...
public class ShopManager : MonoBehaviour
{
    ...
    void SetupShopItems()
    {
        ...
        shopItems[3].Setup("Light Range", "Increase light radius", LightManager.Instance.GetPrice(), LightManager.Instance.GetLevel(), () => LightManager.Instance.UpgradeLightRadius());
